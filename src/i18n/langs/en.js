...
confirm: 'Confirm',
cancel: 'Cancel',
success: 'Congratulations, operation successful',
failed: 'Sorry, operation failed ',
...
nodeError: 'Sorry, you are not connected to the node. Please check the network or modify the node address and try again.',
mobileVersionsTip: 'The phone terminal does not provide the keystore file backup function. If you need to back up the keystore file, please open the wallet on your computer.',
...
ACT004: 'Wrong Address',
ACT005: 'Alias already exists.',
ACT006: 'Alias does not exist',
ACT007: 'The account already has an alias set',
ACT008: 'Parameter error',
ACT009: 'Data parsing error',
ACT010: 'Operation successful',
ACT011: 'Operation failed',
ACT012: 'Insufficient balance',
ACT016: 'Wrong alias format',
MB001: 'Unkown message type',
LEDGER002: 'Repeated transactions',
cs000: 'Consensus module unknown error',
cs005: 'Commission rate error',
cs006: 'Credit ratio too low',
cs007: 'Deposit too large',
cs008: 'Deposit too large',
...
MSG022: 'The address does not belong to the chain',
AL001: 'Account does not exist',
AL004: 'Wrong address',
AL010: 'Operation successful',
AL011: 'Operation failed',
...
50009: 'There is another AliasTransaction set to the same alias',
...
SYS103: 'You already have the testing coins, please do not apply for that more than once!',
...
1005000: 'Parameter error',
1000000: 'The operation failure',
...
pass: 'Wallet password:8-20 characters, letters and numbers are required, and spaces cannot be entered.',
...
passTwoTitle_1: 'The passwords do not coincide',
...
createWalletBackupsKey: 'Private key backup on plaintext',
...
createWalletDialog3: 'The private key is not encrypted, the backup is under risk，',
...
createWalletDialog6: 'Backing up',
...
importKeyErrorTips2: 'No file selected',
...
myConsensus8: 'My involvement',
myConsensus9: 'Not yet involved',
myConsensus10: 'Participate now',
myConsensus11: 'No results',
myConsensus12: 'Total consensus reward',
...
nodeDetail18: 'staking between 2000 and 500000, and eight decimal places',
...
setPassword2: 'New password (8-20 bits, with letters and numbers, and no spaces).',
...
//help
help1: 'Common problems',
help2: 'Import account',
help3: 'Import accounts are divided into private key import and .keystore file import.',
help20: 'The private key import directly enters the plaintext private key, and then sets a password on it.',
...
testnetNuls6: 'I already know that the testnet NULS is only used for the test network and doesn\'t have any othervalue. ',
testnetNuls7: 'Apply',
...
testnetNuls14: 'You have already applied and got ',

//voteList
voteList14: 'Community Voting',
voteList5: 'Voting status',
voteList: 'All',
voteList0: 'Confirming',
voteList1: 'Waiting',
voteList2: 'Voting',
voteList4: 'Finished',
voteList6: 'Create a vote',
//voteList7: 'Please input voting title, initiator address or alias to search',
voteList7: 'Search the title and initial address',
voteList8: 'My Votes',
voteList9: 'Title',
// voteList10: 'Alias/Address',
voteList10: 'Address',
voteList11: 'Status',
voteList12: 'Time',
voteList13: 'Votes',
voteBackName: 'Voting list',
timeDays: ' Days ',
timeDay: ' Day ',
timeHours: ' Hours ',
timeHour: ' Hour ',
...
timeStart: ' Start',
timeEnd: ' End',
voteList15: 'Search the title',

//voteDetail
voteDetail1: 'My Address: ',
voteDetail2: 'Votes Available: ',
voteDetail3: 'Total ',
voteDetail4: ' Votes',
voteDetail5: 'Initiator: ',
voteDetail6: 'Choose at least ',
voteDetail23: ' but no more than ',
voteDetail7: ' options and once submitted, you cannot change your votes.',
voteDetail14: ' options and after submitted, you can change your votes.',
voteDetail15: 'You can only choose one of the options and after submitted, you can change your votes. ',
voteDetail25: 'You can only choose one of the options and once submitted, you cannot change your votes. ',
voteDetail8: 'Options',
voteDetail9: 'Votes',
voteDetail10: 'Percentage',
voteDetail11: 'Details',
voteDetail12: 'Vote',
voteDetail13: 'The number of votes is determined by the total amount of NULS in the address. The ratio of the current number of votes to NULS is 1:1. The part of the total amount after the decimal point is not included.',
voteDetail16: 'Hide',
voteDetail17: '',
voteDetail26: ' left before the voting begins',
voteDetail18: 'Time left: ',
voteDetail19: 'Voting has ended, end time: ',
voteDetail20: 'Update voting',
voteDetail21: 'Already voted',
voteDetail22: 'Voting ends',
voteDetail24: 'The fee is not 0.', // review: then what is the fee?
voteDetail27: 'Please select the option, then click to vote',
voteDetail28: 'Please update the option, then click to update vote',

//createVote
createVote1: 'Create a vote',
createVote2: '*Please fill in all information carefully as you cannot change after the result is submitted.',
createVote3: 'Title: ',
createVote4: 'Introduce: ',
createVote5: 'Please input a clearly described title with no more than 90 characters',
createVote6: 'Please input a brief voting introduction with no more than 450 characters',
createVote7: 'Option ',
createVote8: ': ',
createVote9: 'Options setting: ',
createVote10: 'One choice',
createVote11: 'Multiple choice',
createVote12: 'At least 1 options',
createVote13: 'No more than 1 options',
createVote14: 'Result setting: ',
createVote15: 'Cannot be changed after voting',
createVote16: 'Can be changed after voting',
createVote17: 'Time: ',
createVote18: 'Start time',
createVote19: 'End time',
createVote20: 'Deposit: ',
createVote21: 'In order to improve the validity of the community vote, a deposit is required to create a vote. The unlocked block height is calculated according to the creation time and end time of the vote. The deposit would be unlocked when the block height corresponding to the end time is reached.',
createVote22: 'Current balance: ',
createVote23: 'Reset',
createVote24: 'Confirm',
createVote25: 'The voting results can be modified.',
createVote26: 'Option contents cannot be empty.',
createVote27: 'Add',
createVote28: 'Remove',
createVote29: 'Move up',
createVote30: 'Move down',
createVote31: 'At least choose ',
createVote32: 'Multiple selection ',
createVote33: 'Terms',
createVote34: 'Please fill in the title.',
createVote35: 'Please fill in the introduction.',
createVote36: 'Please choose option settings.',
createVote37: 'Please choose the result set.',
createVote38: 'Please choose at least several items.',
createVote39: 'Please choose more than several items.',
createVote40: 'Please choose the start date.',
createVote41: 'Please choose the end date.',
createVote42: 'Please enter a clear option with a maximum length of 60 characters.',
createVoteError1: 'Start time can not be less than the current time',
createVoteError2: 'The end time can not be less than the current time',
createVoteError3: 'The end time should not be less than the start time',
createVoteError4: 'At least the option should not be greater than most options',
createVoteError5: 'At least option and at most options cannot be 1 at the same time',
createVoteSuccess: 'Success: The voting you have created has been initiated. It takes about a minute to confirm. Please be patient.',
